...
public class AndroidMultipleSelectAction implements IntentAction<MultipleSelectBuilder, List<Uri>> {
    @Override
    public void onStart(Context context, Fragment fragment, MultipleSelectBuilder builder, int requestCode) throws MultimediaException {
        try {
    ...
    @Override
    public List<Uri> onFinish(Context context, MultipleSelectBuilder builder, int resultCode, Intent data) throws MultimediaException {
